 ...
 * @since [产品/模块版本]
 */
public class LeftRightFireStrategy implements TankFireStrategy {
    @Override
    public void fire(Player player) {
        ...
        TankFrame.INSTANCE.getGameMode().add(new Bullet(bX,bY, Dir.L,player.getGroup()));
        TankFrame.INSTANCE.getGameMode().add(new Bullet(bX,bY, Dir.R,player.getGroup()));
    }
}
